...
const TWEET_STRINGS = {
  ...
  dataViewerId: { ja: 'ID', en: 'ID', zh: 'ID', es: 'ID', de: 'ID', fr: 'ID', ko: 'ID' },
  dataViewerDate: { ja: '日付', en: 'Date', zh: '日期', es: 'Fecha', de: 'Datum', fr: 'Date', ko: '날짜' },
  dataViewerUser: { ja: 'ユーザー', en: 'User', zh: '用户', es: 'Usuario', de: 'Benutzer', fr: 'Utilisateur', ko: '사용자' },
  dataViewerContent: { ja: '内容', en: 'Content', zh: '内容', es: 'Contenido', de: 'Inhalt', fr: 'Contenu', ko: '내용' },
  dataViewerLikes: { ja: 'いいね', en: 'Likes', zh: '赞', es: 'Me gusta', de: 'Likes', fr: 'J\'aime', ko: '좋아요' },
  dataViewerTags: { ja: 'タグ', en: 'Tags', zh: '标签', es: 'Etiquetas', de: 'Tags', fr: 'Tags', ko: '태그' },
  dataViewerCopyCsv: { ja: 'CSVコピー', en: 'Copy CSV', zh: '复制CSV', es: 'Copiar CSV', de: 'CSV kopieren', fr: 'Copier CSV', ko: 'CSV 복사' },
  dataViewerCopyMarkdown: { ja: 'Markdownコピー', en: 'Copy Markdown', zh: '复制Markdown', es: 'Copiar Markdown', de: 'Markdown kopieren', fr: 'Copier Markdown', ko: 'Markdown 복사' },
  dataViewerSearchPlaceholder: { ja: '本文検索...', en: 'Search content...', zh: '搜索内容...', es: 'Buscar contenido...', de: 'Inhalt suchen...', fr: 'Rechercher du contenu...', ko: '내용 검색...' },
  dataViewerAllUsers: { ja: '全ユーザー', en: 'All Users', zh: '所有用户', es: 'Todos los usuarios', de: 'Alle Benutzer', fr: 'Tous les utilisateurs', ko: '모든 사용자' },
  dataViewerSortByLikes: { ja: 'いいね数', en: 'Likes', zh: '点赞数', es: 'Nº de Me gusta', de: 'Anzahl Likes', fr: 'Nb de J\'aime', ko: '좋아요 수' },
  copiedAsCsv: { ja: 'CSVとしてコピーしました', en: 'Copied as CSV', zh: '已复制为CSV', es: 'Copiado como CSV', de: 'Als CSV kopiert', fr: 'Copié en tant que CSV', ko: 'CSV로 복사했습니다' },
  copiedAsMarkdown: { ja: 'Markdownテーブルとしてコピーしました', en: 'Copied as Markdown table', zh: '已复制为Markdown表格', es: 'Copiado como tabla Markdown', de: 'Als Markdown-Tabelle kopiert', fr: 'Copié en tant que tableau Markdown', ko: 'Markdown 테이블로 복사했습니다' },
  copyFailed: { ja: 'コピーに失敗しました', en: 'Copy failed', zh: '复制失败', es: 'Error al copiar', de: 'Kopieren fehlgeschlagen', fr: 'La copie a échoué', ko: '복사에 실패했습니다' },
  // tweetWidgetUI
  home: { ja: 'ホーム', en: 'Home', zh: '主页', es: 'Inicio', de: 'Startseite', fr: 'Accueil', ko: '홈' },
  notifications: { ja: '通知', en: 'Notifications', zh: '通知', es: 'Notificaciones', de: 'Benachrichtigungen', fr: 'Notifications', ko: '알림' },
  noNotifications: { ja: '通知はありません', en: 'No notifications', zh: '没有通知', es: 'No hay notificaciones', de: 'Keine Benachrichtigungen', fr: 'Aucune notification', ko: '알림이 없습니다' },
  someone: { ja: '誰か', en: 'Someone', zh: '某人', es: 'Alguien', de: 'Jemand', fr: 'Quelqu\'un', ko: '누군가' },
  repliedToYou: { ja: ' がリプライしました', en: ' replied to you', zh: ' 回复了你', es: ' te respondió', de: ' hat dir geantwortet', fr: ' vous a répondu', ko: '님이 답장했습니다' },
  post: { ja: 'ポスト', en: 'Post', zh: '帖子', es: 'Publicación', de: 'Beitrag', fr: 'Post', ko: '게시물' },
  filterActiveOnly: { ja: '通常のみ', en: 'Active only', zh: '仅活动', es: 'Solo activos', de: 'Nur aktiv', fr: 'Actif seulement', ko: '활성만' },
  filterAll: { ja: 'すべて', en: 'All', zh: '全部', es: 'Todos', de: 'Alle', fr: 'Tout', ko: '모두' },
  filterDeletedOnly: { ja: '非表示のみ', en: 'Hidden only', zh: '仅隐藏', es: 'Solo ocultos', de: 'Nur ausgeblendet', fr: 'Caché seulement', ko: '숨김만' },
  filterBookmarks: { ja: 'ブックマーク', en: 'Bookmarks', zh: '书签', es: 'Marcadores', de: 'Lesezeichen', fr: 'Favoris', ko: '북마크' },
  dataViewer: { ja: 'データビューア', en: 'Data Viewer', zh: '数据查看器', es: 'Visor de Datos', de: 'Datenbetrachter', fr: 'Visionneuse de données', ko: '데이터 뷰어' },
  previewMode: { ja: 'プレビューモード', en: 'Preview Mode', zh: '预览模式', es: 'Modo de vista previa', de: 'Vorschaumodus', fr: 'Mode Aperçu', ko: '미리보기 모드' },
  replyPlaceholder: { ja: '返信をポスト', en: 'Post your reply', zh: '发布你的回复', es: 'Publica tu respuesta', de: 'Poste deine Antwort', fr: 'Publiez votre réponse', ko: '답장 게시' },
  postPlaceholder: { ja: 'いまどうしてる？', en: 'What\'s happening?', zh: '有什么新鲜事？', es: '¿Qué está pasando?', de: 'Was passiert gerade?', fr: 'Quoi de neuf ?', ko: '무슨 일이 일어나고 있나요?' },
  fetchingYoutubeTitle: { ja: '動画タイトル取得中...', en: 'Fetching YouTube title...', zh: '正在获取YouTube标题...', es: 'Obteniendo título de YouTube...', de: 'YouTube-Titel wird abgerufen...', fr: 'Récupération du titre YouTube...', ko: 'YouTube 제목을 가져오는 중...' },
  insertYoutubeTitle: { ja: '「{{title}}」を挿入 → クリック', en: 'Insert "{{title}}" → Click', zh: '插入"{{title}}"→ 单击', es: 'Insertar "{{title}}" → Clic', de: '"{{title}}" einfügen → Klicken', fr: 'Insérer "{{title}}" → Cliquer', ko: '"{{title}}" 삽입 → 클릭' },
  fetchYoutubeTitleFailed: { ja: '動画タイトル取得失敗', en: 'Failed to fetch YouTube title', zh: '获取YouTube标题失败', es: 'Error al obtener el título de YouTube', de: 'YouTube-Titel konnte nicht abgerufen werden', fr: 'Échec de la récupération du titre YouTube', ko: 'YouTube 제목 가져오기 실패' },
  finishEditing: { ja: '編集完了', en: 'Finish editing', zh: '完成编辑', es: 'Finalizar edición', de: 'Bearbeitung beenden', fr: 'Terminer la modification', ko: '편집 완료' },
  reply: { ja: '返信', en: 'Reply', zh: '回复', es: 'Responder', de: 'Antworten', fr: 'Répondre', ko: '답장' },
  postVerb: { ja: 'ポストする', en: 'Post', zh: '发布', es: 'Publicar', de: 'Posten', fr: 'Publier', ko: '게시하기' },
  replyingTo: { ja: '{{user}} さんに返信中', en: 'Replying to {{user}}', zh: '正在回复 {{user}}', es: 'Respondiendo a {{user}}', de: 'Antwort an {{user}}', fr: 'Réponse à {{user}}', ko: '{{user}}님에게 답장 중' },
  attachImage: { ja: '画像を添付', en: 'Attach image', zh: '附加图片', es: 'Adjuntar imagen', de: 'Bild anhängen', fr: 'Joindre une image', ko: '이미지 첨부' },
  bold: { ja: '太字', en: 'Bold', zh: '粗体', es: 'Negrita', de: 'Fett', fr: 'Gras', ko: '굵게' },
  italic: { ja: '斜体', en: 'Italic', zh: '斜体', es: 'Cursiva', de: 'Kursiv', fr: 'Italique', ko: '기울임꼴' },
  restore: { ja: '復元', en: 'Restore', zh: '恢复', es: 'Restaurar', de: 'Wiederherstellen', fr: 'Restaurer', ko: '복원' },
  deletePermanently: { ja: '⚠️ 完全削除', en: '⚠️ Delete permanently', zh: '⚠️ 永久删除', es: '⚠️ Eliminar permanentemente', de: '⚠️ Endgültig löschen', fr: '⚠️ Supprimer définitivement', ko: '⚠️ 영구 삭제' },
  confirmDeletePost: { ja: 'このつぶやきを完全に削除しますか？（元に戻せません）', en: 'Permanently delete this post? (Cannot be undone)', zh: '要永久删除这条推文吗？（无法撤销）', es: '¿Eliminar esta publicación de forma permanente? (No se puede deshacer)', de: 'Diesen Beitrag endgültig löschen? (Kann nicht rückgängig gemacht werden)', fr: 'Supprimer définitivement cette publication ? (Irréversible)', ko: '이 게시물을 영구적으로 삭제하시겠습니까? (되돌릴 수 없습니다)' },
  deleteThreadPermanently: { ja: '🧹 スレッドを完全削除', en: '🧹 Delete thread permanently', zh: '🧹 永久删除串', es: '🧹 Eliminar hilo permanentemente', de: '🧹 Thread endgültig löschen', fr: '🧹 Supprimer le fil de discussion définitivement', ko: '🧹 스레드 영구 삭제' },
  confirmDeleteThread: { ja: 'このスレッド（親＋リプライ）を完全に削除しますか？（元に戻せません）', en: 'Permanently delete this thread (parent + replies)? (Cannot be undone)', zh: '要永久删除这个串（父帖+回复）吗？（无法撤销）', es: '¿Eliminar este hilo (principal + respuestas) de forma permanente? (No se puede deshacer)', de: 'Diesen Thread (Eltern- + Antworten) endgültig löschen? (Kann nicht rückgängig gemacht werden)', fr: 'Supprimer définitivement ce fil de discussion (parent + réponses) ? (Irréversible)', ko: '이 스레드(부모+답글)를 영구적으로 삭제하시겠습니까? (되돌릴 수 없습니다)' },
  visibility: { ja: 'Visibility', en: 'Visibility', zh: '可见性', es: 'Visibilidad', de: 'Sichtbarkeit', fr: 'Visibilité', ko: '공개 범위' },
  noteQuality: { ja: 'Note Quality', en: 'Note Quality', zh: '笔记质量', es: 'Calidad de la nota', de: 'Notizqualität', fr: 'Qualité de la note', ko: '노트 품질' },
  qualityFleeting: { ja: 'アイデア', en: 'Fleeting', zh: '闪念', es: 'Fugaz', de: 'Flüchtig', fr: 'Fugace', ko: '단기' },
  qualityLiterature: { ja: '文献', en: 'Literature', zh: '文献', es: 'Literatura', de: 'Literatur', fr: 'Littérature', ko: '문헌' },
  qualityPermanent: { ja: '永久', en: 'Permanent', zh: '永久', es: 'Permanente', de: 'Dauerhaft', fr: 'Permanent', ko: '영구' },
  taskStatus: { ja: 'Task Status', en: 'Task Status', zh: '任务状态', es: 'Estado de la tarea', de: 'Aufgabenstatus', fr: 'Statut de la tâche', ko: '작업 상태' },
  openCreateContextNote: { ja: 'Open/Create Context Note', en: 'Open/Create Context Note', zh: '打开/创建上下文笔记', es: 'Abrir/Crear nota de contexto', de: 'Kontextnotiz öffnen/erstellen', fr: 'Ouvrir/Créer une note de contexte', ko: '컨텍스트 노트 열기/만들기' },
  quote: { ja: '引用', en: 'Quote', zh: '引用', es: 'Citar', de: 'Zitat', fr: 'Citer', ko: '인용' },
  details: { ja: '詳細', en: 'Details', zh: '详情', es: 'Detalles', de: 'Details', fr: 'Détails', ko: '상세 정보' },
  quoteRetweet: { ja: '引用リツイート', en: 'Quote Retweet', zh: '引用转推', es: 'Citar Retweet', de: 'Zitat-Retweet', fr: 'Citer le Retweet', ko: '인용 리트윗' },
  addComment: { ja: 'コメントを追加', en: 'Add a comment', zh: '添加评论', es: 'Añadir un comentario', de: 'Kommentar hinzufügen', fr: 'Ajouter un commentaire', ko: '댓글 추가' },
  retweet: { ja: 'リツイート', en: 'Retweet', zh: '转推', es: 'Retweet', de: 'Retweeten', fr: 'Retweeter', ko: '리트윗' },
  quoteRetweetList: { ja: '引用リツイート一覧', en: 'Quote Retweet List', zh: '引用转推列表', es: 'Lista de Retweets con Cita', de: 'Liste der Zitat-Retweets', fr: 'Liste des Retweets avec citation', ko: '인용 리트윗 목록' },
  noQuoteRetweets: { ja: 'まだ引用リツイートはありません。', en: 'No quote retweets yet.', zh: '暂无引用转推。', es: 'Aún no hay retweets con cita.', de: 'Noch keine Zitat-Retweets.', fr: 'Pas encore de retweets avec citation.', ko: '아직 인용 리트윗이 없습니다.' },
  editTweet: { ja: 'つぶやきを編集', en: 'Edit Tweet', zh: '编辑推文', es: 'Editar Tweet', de: 'Tweet bearbeiten', fr: 'Modifier le Tweet', ko: '트윗 수정' },
  editTweetPlaceholder: { ja: 'つぶやきを編集', en: 'Edit Tweet', zh: '编辑推文', es: 'Editar Tweet', de: 'Tweet bearbeiten', fr: 'Modifier le Tweet', ko: '트윗 수정' },
  peopleReacted: { ja: 'この人たちが反応しています！', en: 'People reacted to this!', zh: '这些人有反应！', es: '¡La gente ha reaccionado a esto!', de: 'Leute haben darauf reagiert!', fr: 'Des gens ont réagi !', ko: '사람들이 반응했습니다!' },
  noTweetsYet: { ja: 'まだつぶやきがありません。', en: 'No posts yet.', zh: '还没有帖子。', es: 'Aún no hay publicaciones.', de: 'Noch keine Beiträge.', fr: 'Pas encore de publications.', ko: '아직 게시물이 없습니다.' },
  edited: { ja: ' (編集済)', en: ' (edited)', zh: ' (已编辑)', es: ' (editado)', de: ' (bearbeitet)', fr: ' (modifié)', ko: ' (수정됨)' },
  replyingToShort: { ja: '返信先: {{user}}', en: 'Replying to: {{user}}', zh: '回复给: {{user}}', es: 'Respondiendo a: {{user}}', de: 'Antwort an: {{user}}', fr: 'En réponse à: {{user}}', ko: '답장 대상: {{user}}' },
  replyToDeleted: { ja: '削除されたポストへの返信', en: 'Reply to a deleted post', zh: '回复已删除的帖子', es: 'Responder a una publicación eliminada', de: 'Antwort auf einen gelöschten Beitrag', fr: 'Répondre à une publication supprimée', ko: '삭제된 게시물에 답장' },
  bookmarked: { ja: 'Bookmarked', en: 'Bookmarked', zh: '已加书签', es: 'Marcado como favorito', de: 'Lesezeichen gesetzt', fr: 'Mis en favori', ko: '북마크됨' },
  conversationHistory: { ja: '会話履歴', en: 'Conversation History', zh: '对话历史', es: 'Historial de conversación', de: 'Konversationsverlauf', fr: 'Historique de la conversation', ko: '대화 기록' },
  noReplies: { ja: 'リプライはありません', en: 'No replies yet.', zh: '暂无回复。', es: 'Aún no hay respuestas.', de: 'Noch keine Antworten.', fr: 'Pas encore de réponses.', ko: '아직 답장이 없습니다.' },
  copyImage: { ja: '画像をコピー', en: 'Copy image', zh: '复制图片', es: 'Copiar imagen', de: 'Bild kopieren', fr: 'Copier l\'image', ko: '이미지 복사' },
  zoomImage: { ja: '画像を拡大表示', en: 'Zoom image', zh: '缩放图片', es: 'Ampliar imagen', de: 'Bild vergrößern', fr: 'Agrandir l\'image', ko: '이미지 확대' },
  imageCopied: { ja: '画像をコピーしました', en: 'Image copied', zh: '图片已复制', es: 'Imagen copiada', de: 'Bild kopiert', fr: 'Image copiée', ko: '이미지를 복사했습니다' },
  // tweetWidgetUI additions
  generateGeminiReply: { ja: 'Geminiでリプライ生成', en: 'Generate reply with Gemini', zh: '使用Gemini生成回复', es: 'Generar respuesta con Gemini', de: 'Antwort mit Gemini generieren', fr: 'Générer une réponse avec Gemini', ko: 'Gemini로 답장 생성' },
  off: { ja: 'なし', en: 'None', zh: '无', es: 'Ninguno', de: 'Keine', fr: 'Aucun', ko: '없음' },
  oneWeek: { ja: '1週間', en: '1 week', zh: '1周', es: '1 semana', de: '1 Woche', fr: '1 semaine', ko: '1주일' },
} as const;
