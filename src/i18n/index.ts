...
const REFLECTION_WIDGET_STRINGS = {
  ...
  autoTriggerInterval: {
    ...
    zh: '自动生成间隔 (小时)',
    es: 'Intervalo de Generación Automática (horas)',
  ...
  summaryInProgress: {
    ja: '要約生成中です...',
    en: 'Summary generation in progress...',
    zh: '摘要生成中...',
    es: 'Generación de resumen en curso...',
  ...
  summaryComplete: {
    ...
    zh: '摘要完成',
    es: 'Resumen completo',
    de: 'Zusammenfassung vollständig',
    fr: 'Résumé terminé',
    ko: '요약 완료',
  },
  lastGenerated: {
    ja: '最終生成: {{date}}',
    en: 'Last generated: {{date}}',
    zh: '最后生成: {{date}}',
    es: 'Última generación: {{date}}',
    de: 'Zuletzt generiert: {{date}}',
    fr: 'Dernière génération: {{date}}',
    ko: '마지막 생성: {{date}}',
  },
  none: {
    ja: 'なし',
